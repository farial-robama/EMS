      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            {
              label: 'Student',
              val: heads.filter((h) => h.headType === 'Student').length,
              color:
            ...
            {
              label: 'General',
              val: heads.filter((h) => h.headType === 'General').length,
              color:
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                  ...
                  current.map((h, i) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full font-medium ${typeColor(h.headType)}`}
                        >
                          {h.headType}
                        </span>
                      </td>
          ...
          <div className="px-5 py-3 bg-gray-50 dark:bg-gray-700/30 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between gap-3 flex-wrap">
            <p className="text-xs text-gray-400 dark:text-gray-500">
              Showing {Math.min((page - 1) * perPage + 1, heads.length)}–
              {Math.min(page * perPage, heads.length)} of {heads.length} entries
            </p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select
                      ...
                      disabled={mode === 'view'}
                      onChange={(e) =>
                        setForm((f) => ({ ...f, hasChild: e.target.value }))
                      }
                      className={selCls}
                    >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select
                      ...
                      disabled={mode === 'view'}
                      onChange={(e) =>
                        setForm((f) => ({ ...f, headType: e.target.value }))
                      }
                      className={selCls}
                    >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    min={1}
                    onChange={(e) =>
                      setForm((f) => ({ ...f, ordering: e.target.value }))
                    }
                    className={inp}
                  />
                  {errors.ordering && (
                    <p className="text-xs text-red-500">{errors.ordering}</p>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl p-6 max-w-sm w-full">
              ...
              <p className="text-sm text-gray-400 dark:text-gray-500 text-center mb-5">
                ...
                <span className="font-medium text-gray-700 dark:text-gray-200">
                  {heads.find((h) => h.id === deleteId)?.title}
                </span>
