...
const DUMMY_MEDIUMS = [
  { id: 1, medium_name: 'Bangla' },
  { id: 2, medium_name: 'English' },
];
const DUMMY_EDU_LEVELS = [
  { id: 1, level_name: 'School' },
  { id: 2, level_name: 'College' },
];
const DUMMY_DEPARTMENTS = [
  { id: 1, department_name: 'Science' },
  { id: 2, department_name: 'Arts' },
];
const DUMMY_CLASSES = [
...
function F({ label, required, error, col, children }) {
  return (
    <div
      className={
        col === 'full'
          ? 'col-span-full flex flex-col gap-1.5'
...
function QualRow({ label, prefix, form, onChange, boards, divisionOptions }) {
  ...
  const cellInp =
    'w-full px-2 py-1.5 text-xs rounded-md border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 dark:text-white outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-100 dark:focus:ring-blue-900/30 transition-all';
  return (
    <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/20 transition-colors">
      <td className={`${tdCls} pl-4`}>
        <span className="text-xs font-bold text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded-md">
          {label}
        </span>
      </td>
      <td className={tdCls}>
      ...
      {[
        ...
        <td key={col} className={tdCls}>
          <input
            ...
            type={
              ['Gpa', 'Total', 'GpaWithout4th'].includes(col)
                ? 'number'
                : 'text'
            }
...
export default function AddSingleStudent() {
  ...
  const filteredClasses = DUMMY_CLASSES.filter(
    (c) => c.department_id === +formData.department
  );
  const filteredSections = DUMMY_SECTIONS.filter(
    (s) => s.class_id === +formData.className
  );
  const filteredSessions = DUMMY_SESSIONS.filter(
    (s) => s.section_id === +formData.section
  );
  ...
  useEffect(() => {
    if (!isEditMode)
      setFormData((p) => ({ ...p, className: '', section: '', session: '' }));
  }, [formData.department]);
  useEffect(() => {
  ...
  const handleChange = (e) => {
    ...
    setFormData((prev) => {
      ...
      if (
        (name === 'isFatherGuardian' || name === 'isMotherGuardian') &&
        !checked
      ) {
  ...
  const handleSameAddress = () => {
    setSameAddress((s) => {
      if (!s)
        setFormData((p) => ({ ...p, permanentAddress: p.presentAddress }));
      return !s;
    });
  };
  ...
  const validate = () => {
    ...
    if (!formData.fullNameBangla.trim())
      e.fullNameBangla = 'Bangla name is required';
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(errs).length) {
      setErrors(errs);
      document
        .querySelector('[data-error-field]')
  ...
  return (
    <DashboardLayout>
      <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                <input
                  ...
                  className={inp(errors.fullNameBangla)}
                />
              </F>
              ...
              <F label="Study Break Remarks" col="full">
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="If any study break, mention reason…"
                  className={ta(false)}
                />
              </F>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <F label="Father Name" required error={errors.fatherName}>
                <input
                  ...
                  className={inp(errors.fatherName)}
                />
              </F>
              <F label="Father Phone" required error={errors.fatherPhone}>
                <input
                  ...
                  className={inp(errors.fatherPhone)}
                />
              </F>
              <F label="Father NID">
                <input
              ...
              <F label="Father Photo">
                ...
                />
                {previews.fatherImage && (
                  <img
                    src={previews.fatherImage}
                    alt="Father"
                    className="mt-2 w-14 h-14 rounded-lg object-cover border border-gray-200 dark:border-gray-600"
                  />
                )}
              </F>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <F label="Mother Name" required error={errors.motherName}>
                <input
                  ...
                  className={inp(errors.motherName)}
                />
              </F>
              <F label="Mother Phone" required error={errors.motherPhone}>
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Mobile number"
                  className={inp(errors.motherPhone)}
                />
              </F>
              <F label="Mother NID">
                <input
              ...
              <F label="Mother Photo">
                <input
                  ...
                  className="w-full px-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 dark:text-white file:mr-3 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-medium file:bg-blue-50 dark:file:bg-blue-900/30 file:text-blue-600 dark:file:text-blue-400 hover:file:bg-blue-100 transition-all outline-none"
                />
                {previews.motherImage && (
                  <img
                    src={previews.motherImage}
                    alt="Mother"
                    className="mt-2 w-14 h-14 rounded-lg object-cover border border-gray-200 dark:border-gray-600"
                  />
                )}
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              {(formData.isFatherGuardian || formData.isMotherGuardian) && (
                <span className="text-xs bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-2 py-0.5 rounded-full font-medium">
                  Auto-filled from{' '}
                  {formData.isFatherGuardian ? 'Father' : 'Mother'}
                </span>
              )}
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <F label="Guardian Name" required error={errors.guardianName}>
                <input
                  ...
                  className={inp(errors.guardianName)}
                />
              </F>
              <F label="Guardian Phone" required error={errors.guardianPhone}>
                <input
                  ...
                  className={inp(errors.guardianPhone)}
                />
              </F>
              <F label="Relation">
                <input
              ...
              <F label="Guardian Photo">
                <input
                  ...
                  className="w-full px-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 dark:text-white file:mr-3 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-medium file:bg-blue-50 dark:file:bg-blue-900/30 file:text-blue-600 dark:file:text-blue-400 hover:file:bg-blue-100 transition-all outline-none"
                />
                {previews.guardianImage && (
                  <img
                    src={previews.guardianImage}
                    alt="Guardian"
                    className="mt-2 w-14 h-14 rounded-lg object-cover border border-gray-200 dark:border-gray-600"
                  />
                )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <F label="Present Address" required error={errors.presentAddress}>
                <textarea
                  ...
                  className={ta(errors.presentAddress)}
                />
              </F>
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="House, Road, Area, City"
                  className={ta(errors.permanentAddress)}
                />
              ...
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700">
                  {[
                    ...
                    <th
                      key={h}
                      className="px-2 py-3 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide first:pl-5 last:pr-5 whitespace-nowrap"
                    >
                      {h}
                    </th>
                  ))}
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <F label="Bus / Route No">
              <input
                name="busNo"
                value={formData.busNo}
                onChange={handleChange}
                placeholder="Bus or route number"
                className={inp(false)}
              />
            </F>
            <F label="Road / Stop No">
              <input
                name="roadNo"
                value={formData.roadNo}
                onChange={handleChange}
                placeholder="Road or stop number"
                className={inp(false)}
              />
            </F>
            <F label="Pickup Point">
              <input
                name="pickupPoint"
            ...
            <F label="Transport Type">
              {sel('transportType', ['Bus', 'Van', 'Other'], null, null, false)}
            </F>
            <F label="Driver Name">
              <input
                name="driverName"
