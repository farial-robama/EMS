...
export default function SectionTeacherAdvising() {
  ...
  const assignedSections = data.reduce(
    (a, d) => a + d.sections.filter((s) => s.assignedTeacher).length,
    0
  );
    ...
    <DashboardLayout>
      <div className="space-y-5">
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <Breadcrumb
            items={['Dashboard', 'Teacher Setup', 'Section Teacher Advising']}
          />
          {searched && (
            <button
              onClick={handleSave}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          {[
            ...
            {
              label: 'Unassigned',
              val: totalSections - assignedSections,
              color:
            ...
            {[
              {
                name: 'eduLevel',
                label: 'Edu Level',
                opts: ['Higher Secondary', 'Graduate'],
              },
              ...
              { name: 'medium', label: 'Medium', opts: ['Bangla', 'English'] },
              {
                name: 'department',
                label: 'Department',
                opts: ['Science', 'Arts', 'Commerce', 'Business'],
              },
            ].map((f) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            <select
                              ...
                              onChange={(e) =>
                                assignTeacher(ci, si, e.target.value)
                              }
