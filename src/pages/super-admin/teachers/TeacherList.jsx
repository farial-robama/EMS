    ...
    <DashboardLayout>
      <div className="space-y-5">
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          ...
          <button
            onClick={() => navigate('/admin/teacher-setup/add-teacher')}
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            },
            {
              ...
              val: teachers.filter((t) => t.department !== '—').length,
              color:
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5">
                          <button
                            onClick={() =>
                              navigate('/admin/teacher-setup/add-teacher', {
                                state: { teacher: t },
                              })
                            }
                          ...
                          <button
                            onClick={() => setDeleteConfirm(t.code)}
          ...
          <div className="px-5 py-3 bg-gray-50 dark:bg-gray-700/30 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-1">
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1)
                .filter(
                  (p) => p === 1 || p === totalPages || Math.abs(p - safeP) <= 1
                )
